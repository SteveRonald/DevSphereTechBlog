...
interface SearchableCareerListProps {
  careers: Career[];
}

export function SearchableCareerList({ careers }: SearchableCareerListProps) {
      ...
      {filteredCareers.length > 0 ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-lg font-medium mb-2">No results for &ldquo;{searchQuery}&rdquo;</p>
