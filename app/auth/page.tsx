...
function AuthPageContent() {
    ...
    try {
      ...
      const { data, error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
          ...
          queryParams: {
            access_type: "offline",
            prompt: "select_account", // Show account picker for sign-in
          },
        },
      });
      ...
      toast({
        title: "Sign In Error",
        description: error.message || "Failed to sign in with Google. Please make sure Google OAuth is enabled in your Supabase project settings.",
        variant: "destructive",
      });
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      toast({
        title: "Sign Up Error",
        description: error.message || "Failed to sign up with Google. Please make sure Google OAuth is enabled in your Supabase project settings.",
        variant: "destructive",
      });
      setGoogleLoading(false);
    }
